...
import com.spondias.Authentication.AuthenticationApplication;
import com.spondias.Authentication.configuration.JWTService;
import com.spondias.Authentication.entity.AppUser;
import com.spondias.Authentication.entity.Role;
import com.spondias.Authentication.entity.token.Token;
import com.spondias.Authentication.entity.token.TokenType;
...
import com.spondias.Authentication.repository.AppUserRepository;
import com.spondias.Authentication.repository.TokenRepository;
...
public class AuthenticationServiceImpl implements AuthenticateService {
    ...
    public OTPResponseModel signUpUser(SignUpRequestModel body) throws AuthenticationException {
        ...
        try {
            if(AuthenticationApplication.getAccessToken() == null || AuthenticationApplication.getAccessToken().equalsIgnoreCase("")){
                System.out.println(AuthenticationApplication.getAccessToken());
...
//        log.info("app user = {}", appUser.get());
    ...
    private void sendOTP(String phoneNumber) throws URISyntaxException, IOException, InterruptedException, AuthenticationException {
        ...
        log.info("SMS token for hormuud {}", AuthenticationApplication.getAccessToken());
        HttpRequest request = HttpRequest.newBuilder()
                .uri(new URI("https://smsapi.hormuud.com/api/SendSMS"))
                .setHeader("Content-Type", "application/json")
                .header("Authorization", "Bearer "+ AuthenticationApplication.getAccessToken())
